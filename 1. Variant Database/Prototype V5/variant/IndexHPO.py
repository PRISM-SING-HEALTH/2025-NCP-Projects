"""
This script utilises code from the FastHPOCR project, developed by Tudor Groza 
and collaborators, without modifications.
...
class IndexHPO:
    ...
    def loadClusterData(self):
        self.clusters = {}
        count = 1
        with open(join(self.resFolder, BASE_CLUSTERS), 'r', encoding='utf-8') as f:
            lines = f.readlines()
            for line in lines:
                line = line.strip()
                if line:
